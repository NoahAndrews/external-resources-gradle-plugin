...
public class WrappedDevice extends GroovyObjectSupport implements IDevice, GroovyObject {
    public WrappedDevice(IDevice device) {
        this.device = device;
    }

    public static WrappedDevice[] wrapDevices(IDevice[] devices) {
    ...
    public String getName() {
        final String model = getProperty(IDevice.PROP_DEVICE_MODEL);
